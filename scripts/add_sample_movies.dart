...
void main() async {
  ...
  final moviesCollection = firestore.collection('movies');
  ...
  final movies = [
    ...
    },
    {
      ...
      'backdropUrl':
          'https://image.tmdb.org/t/p/original/7c9UVPPiTPltouxRVY6N9uGRN5h.jpg',
    ...
    },
    {
      ...
      'backdropUrl':
          'https://image.tmdb.org/t/p/original/1LRLLWGvs5sZdTzuMqLEahb88Pc.jpg',
    ...
    },
    {
      ...
      'backdropUrl':
          'https://image.tmdb.org/t/p/original/2MFIhZAW0CVlEQrFyqwa4U6MOxz.jpg',
  ...
  print('🎬 Đang thêm 10 phim vào Firestore...\n');
  ...
  for (var movie in movies) {
    try {
      ...
      count++;
      print('✅ Đã thêm: ${movie['title']} (${movie['year']})');
    } catch (e) {
      print('❌ Lỗi khi thêm ${movie['title']}: $e');
    }
  }

  print('\n🎉 Hoàn thành! Đã thêm $count/10 phim vào database.');
  print('🔥 Firebase Project: cinechill-dev');
}
